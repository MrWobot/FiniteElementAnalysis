...
namespace MagneticDoubleCone
{
    ...
    public class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            string MAGNETIC_FIELD_PLY_FILE_PATH = Path.Combine(outputDirectory, "magneticField.ply");
            string CURRENT_DENSITIES_FIRST_HALF_PLY_FILE_PATH = Path.Combine(outputDirectory, "coilCurrentDensitiesFirstHalf.ply");
            string CURRENT_DENSITIES_SECOND_HALF_PLY_FILE_PATH = Path.Combine(outputDirectory, "coilCurrentDensitiesSecondHalf.ply");
            ...
            double maximumTetrahedronVolumeConstraintWinding = 10e-7;
