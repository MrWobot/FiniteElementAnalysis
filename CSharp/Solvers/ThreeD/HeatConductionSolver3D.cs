...
namespace FiniteElementAnalysis.Solvers.ThreeD
{
    ...
    public class HeatConductionSolver3D : ScalarSolver3D<HeatConductionResult3D>
    {
        public HeatConductionSolver3D() : base(FieldOperationType.Gradient)
        {
        }
    ...
    double[] rhs)
        ...
        public override HeatConductionResult3D Solve(TetrahedralMesh mesh, WorkingDirectoryManager workingDirectoryManager, string operationIdentifier = "default", DelegateApplySourceRegion[]? applySourceRegion_s = null, SolverMethod solverMethod = SolverMethod.BlockMatrixInversionGpuOnly, CompositeProgressHandler? progressHandler = null, FileCachedItem<CoreSolverResult>? cachedSolverResult = null, bool useCachedSolverResults = false)
        {
